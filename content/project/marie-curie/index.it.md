...
image:
  ...
  focal_point: Smart
summary: "I fattori che guidano i cambiamenti nella forma e nelle dimensioni del corpo dei rondoni maggiori adulti: c'è un effetto del cambiamento climatico? Verso un approccio integrato per comprenderne i meccanismi, le conseguenze lungo l'arco della vita e per migliorare la nostra capacità predittiva."
...
__Effetti del cambiamento climatico sulle dimensioni corporee in età adulta: verso un approccio integrato per comprenderne i meccanismi, le conseguenze lungo l'arco della vita e per migliorare la nostra capacità predittiva__

__Finanziamento__: Questo progetto ha ricevuto finanziamenti dal programma di ricerca e innovazione Horizon 2020 dell'Unione Europea nell'ambito della Marie Skłodowska-Curie grant agreement n. 101025938, nome progetto CLIMGROWTH. <a href="https://cordis.europa.eu/project/id/101025938" target="_blank" rel="noopener noreferrer">Pagina ufficiale del progetto</a>.

<a href="https://cordis.europa.eu/project/id/101025938">
{{< figure src="msca.png" width="200px" alt="Logo Marie Skłodowska-Curie Actions (Unione Europea, Horizon 2020)" >}}
</a>
...
{{< figure src="fig_art1.jpg" caption="Traiettorie di sviluppo, dalla schiusa all'involo, di pulli di rondone maggiore. I punti rappresentano misurazioni individuali di lunghezza di ala, sterno e massa corporea di pulli misurati tra il 1999 e il 2023; le linee rappresentano il pattern di crescita medio. Le finestre sensibili dello sviluppo in cui le condizioni meteorologiche hanno influenzato maggiormente il fenotipo a 50 giorni (vedi sezione 3) sono evidenziate con uno sfondo viola. N = 15.866 misure da 3194 pulli per la lunghezza dell'ala, 12.662 misure da 2887 pulli per la lunghezza dello sterno e 15.968 da 3188 pulli per la massa corporea." width="400px" numbered="false">}}
...
__Un video di una delle nostre colonie a Soletta__
...
__<a href="https://scholar.google.com/citations?hl=it&user=AQOliiAAAAAJ" target="_blank" rel="noopener noreferrer">Dr. Pierre Bize</a>__, Istituto Ornitologico Svizzero, Svizzera

__<a href="https://scholar.google.com/citations?user=w6axPGHSSWsC&hl=it&oi=ao" target="_blank" rel="noopener noreferrer">Prof. Julien Martin</a>__, Università di Ottawa, Canada. <a href="https://juliengamartin.github.io/" target="_blank" rel="noopener noreferrer">Sito del gruppo di ricerca</a>.

__<a href="https://www.researchgate.net/profile/Michela-Dumas" target="_blank" rel="noopener noreferrer">Michela Dumas</a>__, Università di Ottawa, Canada
