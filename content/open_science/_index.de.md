...
Unterzeichnerin des Commitment to Research Transparency:
...
* **2026 –** Mitglied des EcoEvoRxiv-Komitees der Society for Open, Reliable, and Transparent Ecology and Evolutionary Biology ([SORTEE](https://www.sortee.org/)).

* **2025 –** Mit Matthieu Paquet habe ich einen Workshop zu Open Science und SORTEE-Aktivitäten bei der EOU 2025 in Bangor organisiert.

* **2025 –** Mitglied des Education & Outreach Committee von [SORTEE](https://www.sortee.org/).

* **2024 –** Mitglied des Conference Committee von [SORTEE](https://www.sortee.org/).

<a href="https://www.sortee.org/" target="_blank" rel="noopener noreferrer">

{{< figure library="true" src="logo_sortee.png" width="100px" alt="Logo von SORTEE (Society for Open, Reliable, and Transparent Ecology and Evolutionary Biology)" >}}
</a>

* **2024 –** Mit dem Conference Committee habe ich an der Organisation der SORTEE Conference 2024 mitgewirkt: alle Informationen zu vergangenen Konferenzen [HIER](https://www.sortee.org/past).

* **2024 –** Interview für die Zeitschrift AvoinTiede von Elina Koivisto <a href="https://avointiede.fi/en/news/sharing-gives-data-wings-and-posture" target="_blank" rel="noopener noreferrer">"Sharing data gives wings and posture"</a> (auf Finnisch: <a href="https://avointiede.fi/fi/ajankohtaista/avoin-jakaminen-antaa-aineistolle-siivet-ja-ryhtia-haastattelussa-giulia-masoero" target="_blank" rel="noopener noreferrer">"Link"</a>). Sekretariat für die Nationale Koordination von Open Science und Forschung. Verband der finnischen wissenschaftlichen Gesellschaften.

* **2023 –** Eingeladener Vortrag beim Workshop **Open Science – Improving your research workflow to increase transparency and reproducibility**, organisiert an der Universität Neuchâtel, Schweiz.

{{< figure library="true" src="OS-flyer.jpeg" width="500px" alt="Flyer zum Open-Science-Workshop an der Universität Neuchâtel, Schweiz (2023)" >}}

<p> </p>

### Offene Daten

Öffentlich archivierte Datensätze (und Analyseskripte):
...
### Mein Open Science Framework (OSF) Profil

<a href="https://osf.io/ct7g5/" target="_blank" rel="noopener noreferrer">
{{< figure library="true" src="logo_osf.png" width="400px" alt="Logo des Open Science Framework (OSF)" >}}
</a>
